...
$.fn.KinSlideshow = function(settings){
	 ...
	 function KSS_setBtn(){
		 ...
		 if(settings.isHasBtn && KSS_imgaeLength >= 2){
			 $(ksthis).append("<div class='KSS_btnBox' style='position:absolute;right:10px;bottom:5px; z-index:50'></div>");
			 var KSS_btnList = "";
			 ...
			 $(ksbs+" .KSS_btnBox #btnlistID li").css({listStyle:"none",float:"left",width:15,height:15,borderWidth:settings.btn.btn_borderWidth,borderColor:settings.btn.btn_borderColor,borderStyle:"solid",background:settings.btn.btn_bgColor,textAlign:"center",cursor:"pointer",marginLeft:3,fontSize:12,fontFamily:settings.btn.btn_fontFamily,lineHeight:"15px",opacity:settings.btn.btn_bgAlpha,color:settings.btn.btn_fontColor});
